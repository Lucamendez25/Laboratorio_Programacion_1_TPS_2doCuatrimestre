...
///
/// @param recibe la direccion de la cantidad de jugadores de una determinada region
/// @param recibe la direccion del contador de jugadores total
...
///
/// @param recibe la direccion del valor de hospedaje
/// @param recibe la direccion del valor de comida
/// @param recibe la direccion del valor de transporte
